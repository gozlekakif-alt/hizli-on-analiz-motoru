...
APP_VERSION = "META V6 — Yaşam Döngüsü + Koltuklu MASTER-20"
...
st.title("🧠 Hızlı On — META V6 Yaşam Döngüsü + Koltuklu MASTER-20")
st.caption(
...
with st.expander("🌙 Dinlenmiş dönüş + geçiş + birliktelik ayrıntısı"):
    cols_show = [
        ...
        "Birliktelik Desteği","MASTER-20","Koltuk"
    ]
    st.dataframe(
...
with st.expander("🧬 META beyninde kullanılan analizler"):
    st.write(
        ...
        "MASTER-20 artık doğrudan ilk 20 META puanı değildir; dinamik koltuk planıyla oluşturulur."
    )
