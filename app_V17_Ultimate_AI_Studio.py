...
st.set_page_config(
    page_title="Hızlı On Ultimate AI Studio V17.0",
    page_icon="🎯",
    layout="wide",
)
...
st.title("🎯 Hızlı On Ultimate AI Studio V17.0")
...
if page == "✅ Kontrol":
    st.success("Çalışan sürüm: V17.0 — Ana dosya: app.py")
...
st.caption(
    "V17.0 blok doğumu, blok kayması, komşuluk/küme tamamlama ve kalıcı motor hafızasını V16 karar mimarisine ekler. "
