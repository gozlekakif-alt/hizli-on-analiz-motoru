...
st.set_page_config(
    page_title="Hızlı On V13.2 Canlı Kupon + Kupon Hafızası",
    page_icon="🌙",
    layout="wide",
)

st.title("🌙 Hızlı On V13.2 — Canlı Kupon + Kupon Hafızası")
st.caption(
...
st.caption(
    "V13.2 canlı hedef varsa 7A + 7B + 10'lu kuponu doğrudan gösterir; gece tamamlanınca son kuponları ekrandan silmez. 2 adet 7'li + 1 adet 10'lu üretir. Yüksek skor tek başına seçim sebebi değildir. "
