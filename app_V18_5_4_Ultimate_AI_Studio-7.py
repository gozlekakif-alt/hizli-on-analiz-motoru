...
st.set_page_config(
    page_title="Hızlı On Ultimate AI Studio V18.5.4",
    page_icon="🎯",
    layout="wide",
)
...
st.title("🎯 Hızlı On Ultimate AI Studio V18.5.4")
...
if page == "✅ Kontrol":
    st.success("Çalışan sürüm: V18.5.4 — Ana dosya: app.py")
    ...
    if len(df) < 100:
        ...
        st.subheader("4️⃣ V18.5.4 Nefes Puanı")
        st.dataframe(
            master18[
                [
                    "Sayı",
