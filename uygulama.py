...
st.set_page_config(
    page_title="Hızlı On Ultimate Analiz Motoru V10.2",
    page_icon="🎯",
    layout="wide",
)
...
st.title("🎯 Hızlı On Ultimate Analiz Motoru V10.2")
...
if page == "✅ Kontrol":
    st.success("Çalışan sürüm: V10.2 — Ana dosya: app.py")
...
st.caption(
    "V10.2 telefonda yalnız seçilen bölümü hesaplar. "
