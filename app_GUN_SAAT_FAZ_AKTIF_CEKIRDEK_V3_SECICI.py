...
# UI
# ============================================================
st.title("🎯 GÜN × SAAT × FAZ AKTİF ÇEKİRDEK V3 — SEÇİCİ")
st.caption("V2 faz dönüşümü korunur. V3 yalnız kronolojik testte avantajı koruyan SABAH-B ve AKŞAM-A olgun çekirdeklerinde KONUŞUR; diğer durumlarda PAS.")
...
with tabs[0]:
    ...
    if isinstance(wf,pd.DataFrame) and len(wf):
        ...
        st.download_button(
            ...
            file_name=f"GUN_SAAT_FAZ_V3_SECICI_{len(wf)}.csv",
