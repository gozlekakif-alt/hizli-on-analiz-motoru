...
# UI
# ============================================================
st.title("🎯 GÜN × SAAT × FAZ V5 — OLAY SEÇİCİ LAB")
st.caption("V3 dondurulmuş çekirdek korunur. V4 raporlanır. V5 ise zayıf KONUŞ olaylarını tamamen PAS geçmeyi sınar.")
...
with tabs[0]:
    ...
    if isinstance(wf,pd.DataFrame) and len(wf):
        ...
        st.download_button(
            ...
            file_name=f"GUN_SAAT_FAZ_V5_OLAY_SECICI_{len(wf)}.csv",
