...
st.set_page_config(
    page_title="Hızlı On — FINAL Uzman V3",
    page_icon="🎯",
    layout="wide",
)
...
st.title("🎯 HIZLI ON — FINAL UZMAN V3 — AKIŞ KİLİTLİ")
st.caption(
...
st.divider()
st.caption(
    "FINAL V3 ilkesi: Elenen GEÇİŞ / DİNLENME / KOMŞU / BİRLİKTELİK / BANT bağımsız sayı üretmez. "
