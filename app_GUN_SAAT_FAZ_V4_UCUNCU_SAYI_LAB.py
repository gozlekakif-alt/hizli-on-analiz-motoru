...
# UI
# ============================================================
st.title("🧪 GÜN × SAAT × FAZ V4 — ÜÇÜNCÜ SAYI LAB")
st.caption("Dondurulmuş V3 aynen korunur. V4 yalnız V3 konuştuğunda üçüncü sayının puan ayrımını sınar; gerekirse 3 yerine 2 sayı söyler.")
...
with tabs[0]:
    ...
    if isinstance(wf,pd.DataFrame) and len(wf):
        ...
        st.download_button(
            ...
            file_name=f"GUN_SAAT_FAZ_V4_UCUNCU_SAYI_{len(wf)}.csv",
