...
st.set_page_config(
    page_title="Hızlı On Ultimate AI Studio V15.0",
    page_icon="🎯",
    layout="wide",
)
...
st.title("🎯 Hızlı On Ultimate AI Studio V15.0")
...
if page == "✅ Kontrol":
    st.success("Çalışan sürüm: V15.0 — Ana dosya: app.py")
...
st.caption(
    "V15.0 canlı fazı tanır, ağırlıkları duruma göre değiştirir, benzer tarihsel durumları bulur ve tüm motorları tek kararda birleştirir. "
