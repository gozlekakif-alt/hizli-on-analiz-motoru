...
st.set_page_config(
    page_title="Hızlı On Ultimate AI Studio V18.2",
    page_icon="🎯",
    layout="wide",
)
...
st.title("🎯 Hızlı On Ultimate AI Studio V18.2")
...
if page == "✅ Kontrol":
    st.success("Çalışan sürüm: V18.2 — Ana dosya: app.py")
    ...
    if len(df) < 100:
        ...
        if st.button(
            ...
            st.session_state["v180_locked_target_draw"] = int(calendar.get("Sonraki Çekiliş"))
...
st.caption(
    "V18.2 V18.1 özelliklerini korur; Streamlit hedef-saat widget çakışmasını giderir ve hedef çekiliş kilidini ayrı güvenli session anahtarlarında tutar. "
