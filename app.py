...
with tabs[4]:
    ...
    if isinstance(bt,pd.DataFrame) and not bt.empty:
        expected={"4 Çekirdek":1.0,"4 Alternatif":1.0,"5 Çekirdek":1.25,"5 Alternatif":1.25,"Canlı5":1.25,"Havuz12":3.0,"Havuz16":4.0,"V2 Havuz16":4.0,"Gün Ligi Havuz16":4.0,"Cerrahi5":1.25}
