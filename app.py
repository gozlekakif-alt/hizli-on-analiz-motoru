...
st.markdown('---')
st.caption('V1: Saatlik aile avcısı. Üç uzman motor + ortak-hakem + PAS + no-future geri test. %100 garanti vermez; amaç gerçek ileri-test performansını ölçmektir.')
