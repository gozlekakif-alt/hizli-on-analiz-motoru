# DOSYA_KIMLIGI: V18.5.13_CANLI_KARAKTER_FAZ_FINAL
import base64
...
st.set_page_config(
    page_title="Hızlı On Ultimate AI Studio V18.5.13 + Canlı Faz",
    page_icon="🎯",
    layout="wide",
)
...
st.title("🧭 Hızlı On — CANLI KARAKTER / OTOMATİK FAZ V18.5.13")
