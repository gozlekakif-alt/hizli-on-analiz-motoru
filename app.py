...
st.set_page_config(
    page_title="Hızlı On Ultimate AI Studio V18.5.6.7",
    page_icon="🎯",
    layout="wide",
)
...
st.title("🎯 Hızlı On Ultimate AI Studio V18.5.6.7")
...
if page == "✅ Kontrol":
    ...
    if len(df) < 100:
        ...
        st.subheader("4️⃣ V18.5.6.7 Nefes Puanı")
        st.dataframe(
            master18[
                [
                    "Sayı",
        ...
        st.write("**🧩 V18.5.6.7 Blok Rejim / Mikro-Konum Kararı**")
        ...
        st.write("**🔁 V18.5.6.7 Elden Ele Taşıma Kimliği**")
        ...
        st.write("**🌙 V18.5.6.7 Dinlenmiş Dönüş Motoru**")
        ...
        st.caption("🏆 V18.5.6.7 OYNA — MASTER 7: Motor formu + çapraz motor onayı + taşıma + dinlenmiş dönüş + blok + bölge/mikro + eşlikçi + rejim kırılma sigortasını 7 koltuklu tek nihai kolonda birleştirir.")
