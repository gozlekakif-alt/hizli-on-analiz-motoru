...
st.set_page_config(
    page_title="Hızlı On Ultimate AI Studio V18.5.3",
    page_icon="🎯",
    layout="wide",
)
...
st.title("🎯 Hızlı On Ultimate AI Studio V18.5.3")
...
if page == "✅ Kontrol":
    st.success("Çalışan sürüm: V18.5.3 — Ana dosya: app.py")
    ...
    if len(df) < 100:
                ...
                if not settings_error:
                    try:
                        ...
                        if len(combined) > before_count:
                            ...
                            st.success(
                                "🧠 V18.5.3 sonucu otomatik öğrendi ve GitHub motor hafızasına yazdı."
                            )
                            st.info(
        ...
        st.info(
            ...
            "V18.5.3, V18.5.2 özelliklerini aynen korur; V18 kuponları sonuçtan önce kalıcı bekleyen hafızaya yazılır, gerçek sonuç gelince otomatik öğrenilir ve motor katsayıları geçmiş performansa göre değişir."
        )
