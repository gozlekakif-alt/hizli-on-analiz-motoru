...
st.set_page_config(
    page_title="Hızlı On Ultimate Analiz Motoru V11.0",
    page_icon="🎯",
    layout="wide",
)
...
st.title("🎯 Hızlı On Ultimate Analiz Motoru V11.0")
...
if page == "✅ Kontrol":
    st.success("Çalışan sürüm: V11.0 — Ana dosya: app.py")
...
st.caption(
    "V11.0 kuponları kaydeder, yeni sonuçları otomatik kontrol eder ve profil başarılarından öğrenir. "
