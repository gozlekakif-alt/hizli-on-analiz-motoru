...
if st.button("🧬 TAM GÜN MASTER PAKETİNİ HAZIRLA (217×80 + 20×60)",use_container_width=True,key="visible_prepare_full_day"):
    with st.spinner("217×80 yaşam + 217 hedef puan/netleşme + 260.400 adet 20×60 kimlik karşılaştırması hazırlanıyor..."):
        try:
