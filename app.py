...
st.set_page_config(
    page_title="Hızlı On Ultimate AI Studio V18.5.6.5",
    page_icon="🎯",
    layout="wide",
)
...
if page == "✅ Kontrol":
    ...
    if len(df) < 100:
        ...
        st.subheader("4️⃣ V18.5.6.5 Nefes Puanı")
        st.dataframe(
            master18[
                [
                    "Sayı",
        ...
        st.write("**🧩 V18.5.6.5 Blok Rejim / Mikro-Konum Kararı**")
        ...
        st.write("**🔁 V18.5.6.5 Elden Ele Taşıma Kimliği**")
