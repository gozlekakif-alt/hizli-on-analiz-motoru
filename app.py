...
st.set_page_config(
    page_title="Hızlı On Ultimate AI Studio V18.5.6.3",
    page_icon="🎯",
    layout="wide",
)
...
def consensus_coupon_v1856(items, master, latest_set, skeleton, size=7):
    ...
    carriers = carriers.sort_values(
        ["Taşıma Kimlik 563", "Devam Puanı 562", "Taşıma Kimlik", "Konsensüs 56"],
...
if page == "✅ Kontrol":
    ...
    if len(df) < 100:
        ...
        st.subheader("4️⃣ V18.5.6.3 Nefes Puanı")
        st.dataframe(
            master18[
                [
                    "Sayı",
        ...
        st.write("**🧩 V18.5.6.3 Blok Rejim / Mikro-Konum Kararı**")
        ...
        st.write("**🔁 V18.5.6.3 Elden Ele Taşıma Kimliği**")
        ...
        st.caption("V18.5.6.3: taşıma adedi korunur + benzer-geçiş taşıma kimliği + ortak çekirdek freni + blok bölgesinden kupona mikro-aday aktarımı.")
        q1, q2 = st.columns(2)
        with q1:
