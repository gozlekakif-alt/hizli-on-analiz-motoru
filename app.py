...
def predict(df,target_time,brain=None):
    ...
    v9final4,tab=_v9_dynamic_conductor(df,tab,pool16_akor,v7final4,4)
    v9final5,tab=_v9_dynamic_conductor(df,tab,pool16_akor,v7final5,5)
    v9meta=dict(tab.attrs.get("v9_swap_meta",{}))
