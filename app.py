...
# -------------------------------------------------------------------
st.title("🧪 Ardışık + Blok Motor Laboratuvarı V3 — Seçici Uzman")
st.caption(
    "META kapalı. V3 önce davranış motorunu çalıştırır, sonra yalnız geçmişte gerçekten avantaj "
    "göstermiş rejimlerde konuşur. Uygun rejim yoksa 0 koltuk ister."
)
