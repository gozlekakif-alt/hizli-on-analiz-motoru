...
st.set_page_config(
    page_title="Hızlı On Ultimate Analiz Motoru V11.1",
    page_icon="🎯",
    layout="wide",
)
...
st.title("🎯 Hızlı On Ultimate Analiz Motoru V11.1")
...
if page == "✅ Kontrol":
    st.success("Çalışan sürüm: V11.1 — Ana dosya: app.py")
...
st.caption(
    "V11.1 bozuk çekiliş numaralarını otomatik onarır; kupon takibi ve öğrenme özelliklerini korur. "
