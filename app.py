...
st.set_page_config(
    page_title="Hızlı On Ultimate AI Studio V18.5.6.2",
    page_icon="🎯",
    layout="wide",
)
...
if page == "✅ Kontrol":
    ...
    if len(df) < 100:
        ...
        _carry562 = carry_continue_break_v18562(master1856, latest_set)
        _carry562 = _carry562[_carry562["Sayı"].astype(int).isin(latest_set)].sort_values(
