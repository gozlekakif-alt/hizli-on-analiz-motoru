...
st.set_page_config(
    page_title="Hızlı On Ultimate Analiz Motoru V13.0",
    page_icon="🎯",
    layout="wide",
)
...
st.title("🎯 Hızlı On Ultimate Analiz Motoru V13.0")
...
if page == "✅ Kontrol":
    st.success("Çalışan sürüm: V13.0 — Ana dosya: app.py")
...
st.caption(
    "V13.0 elden ele taşınan sayıları, yeni gelenleri ve blok ağlarını kupon üretimine bağlar. "
