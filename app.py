...
st.set_page_config(
    page_title="Hızlı On Ultimate AI Studio V18.5.2",
    page_icon="🎯",
    layout="wide",
)
...
st.title("🎯 Hızlı On Ultimate AI Studio V18.5.2")
...
if page == "✅ Kontrol":
    st.success("Çalışan sürüm: V18.5.2 — Ana dosya: app.py")
    ...
    if len(df) < 100:
        ...
        st.info(
            ...
            "V18.5.2, V18.5.1 özelliklerini aynen korur; 07.08.2026 10:02 = #47356 resmî ankrajıyla yalnızca çekiliş numarası eşleştirmesi düzeltilir."
        )
