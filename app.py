...
st.set_page_config(
    page_title="Hızlı On Ultimate AI Studio V18.5.6.4",
    page_icon="🎯",
    layout="wide",
)
...
if page == "✅ Kontrol":
    ...
    if len(df) < 100:
        ...
        st.subheader("4️⃣ V18.5.6.4 Nefes Puanı")
        st.dataframe(
            master18[
                [
                    "Sayı",
        ...
        st.write("**🧩 V18.5.6.4 Blok Rejim / Mikro-Konum Kararı**")
        ...
        st.write("**🔁 V18.5.6.4 Elden Ele Taşıma Kimliği**")
        ...
        st.caption("V18.5.6.4: önceki motorlar korunur + Çekirdek→Eşlikçi (P(X|çekirdek), lift, kısa dönem, taşıma beraberliği, komşuluk) + kopya kupon freni.")
        q1, q2 = st.columns(2)
        with q1:
