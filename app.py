...
st.set_page_config(
    page_title="Hızlı On Ultimate Analiz Motoru V10.4",
    page_icon="🎯",
    layout="wide",
)
...
st.title("🎯 Hızlı On Ultimate Analiz Motoru V10.4")
...
if page == "✅ Kontrol":
    st.success("Çalışan sürüm: V10.4 — Ana dosya: app.py")
...
st.caption(
    "V10.4 geçiş, tekrar, güç, saat, dönüş, blok ve birlikte gelme analizlerini ortaklaştırır. "
