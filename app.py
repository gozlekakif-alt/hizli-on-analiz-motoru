...
st.title("🎼 Sayı Laboratuvarı v2.1 — Orkestra Motoru")
st.caption("Kalıcı veri.txt + zincir bütünlüğü + saat karakteri + 64 yol + 80 sayı profili + nota20 + Live Blind.")
...
try:
    if uploaded is not None:
        ...
        data_source_label = "Kalıcı repo verisi: veri.txt"
