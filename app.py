...
st.set_page_config(
    page_title="Hızlı On Ultimate AI Studio V18.5.1",
    page_icon="🎯",
    layout="wide",
)
...
st.title("🎯 Hızlı On Ultimate AI Studio V18.5.1")
...
if page == "✅ Kontrol":
    st.success("Çalışan sürüm: V18.5.1 — Ana dosya: app.py")
    ...
    if len(df) < 100:
        ...
        st.info(
            ...
            "V18.5.1, V18.5 özelliklerini aynen korur; V18.4 ara puan kolonu ile V18.5 son puanı arasındaki KeyError düzeltildi."
        )
