...
st.set_page_config(
    page_title="Hızlı On Ultimate AI Studio V18.5.6.6",
    page_icon="🎯",
    layout="wide",
)
...
st.title("🎯 Hızlı On Ultimate AI Studio V18.5.6.6")
...
def generate_v1856_coupons(master1856, latest_set, skeleton, block_forecast, block_birth185,
    ...
    # V18.5.6.6 — Tüm motorların tek nihai ortak kolonu.
    # Eski senaryoları bozmaz; onların sonuç-öncesi kanıtlarını birleştirir.
    _master566 = master_item_v18566(
        df_hist,
        master1856,
        items,
        latest_set,
    ...
    if _master566.get("Kupon"):
        items.append(_master566)
...
if page == "✅ Kontrol":
    ...
    if len(df) < 100:
        ...
        st.subheader("4️⃣ V18.5.6.6 Nefes Puanı")
        st.dataframe(
            master18[
                [
                    "Sayı",
        ...
        st.write("**🧩 V18.5.6.6 Blok Rejim / Mikro-Konum Kararı**")
        ...
        st.write("**🔁 V18.5.6.6 Elden Ele Taşıma Kimliği**")
        ...
        st.write("**🌙 V18.5.6.6 Dinlenmiş Dönüş Motoru**")
        ...
        st.caption("🏆 V18.5.6.6 ANA ORTAK / MASTER: Taşıma + Dinlenmiş Dönüş + Blok + Mikro-Bölge + Çekirdek→Eşlikçi + Blok Paketi + senaryo oylarını tek nihai kolonda birleştirir. Sonuç bilgisi kullanılmaz.")
