...
st.set_page_config(
    page_title="Hızlı On Ultimate AI Studio V18.5.5",
    page_icon="🎯",
    layout="wide",
)
...
st.title("🎯 Hızlı On Ultimate AI Studio V18.5.5")
...
if page == "✅ Kontrol":
    st.success("Çalışan sürüm: V18.5.5 — Ana dosya: app.py")
    ...
    if len(df) < 100:
        ...
        st.subheader("4️⃣ V18.5.5 Nefes Puanı")
        st.dataframe(
            master18[
                [
                    "Sayı",
        ...
        st.info(
            ...
            "V18.5.5, V18.5.4 ve önceki öğrenme/hafıza yapısını korur; blok kayma varyantı, bölge yorgunluğu, ortak çekirdek güveni ve kupon çeşitlilik freni son seçim katmanına kontrollü biçimde eklenmiştir."
        )
