...
with tabs[4]:
    ...
    if isinstance(bt,pd.DataFrame) and not bt.empty:
        ...
        if "Birleşik Beyin Havuz16" in bt.columns:
            ...
            st.caption("Birleşik Beyin V2 GÖZLEMCİDİR: GAP-6+ rescue, GAP-3 koruma, GAP-1 fren, kapılı carry ve 3-el blok CONFIRM mantığını uygular; canlı MASTER'a henüz dokunmaz.")
